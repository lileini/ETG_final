...
public class DragLayout extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
    	LogUtil.i("onInterceptTouchEvent", "onInterceptTouchEvent");
    	boolean b = dragHelper.shouldInterceptTouchEvent(ev) && gestureDetector.onTouchEvent(ev);
    	LogUtil.i("onInterceptTouchEvent", b);
        return b;
    //	return false;
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        try {
        	LogUtil.i("dgTouchEvent", e.getAction());
