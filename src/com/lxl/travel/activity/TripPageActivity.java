		...
		searchCity_Bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ETGApplication.location != null) {
					...
					Toast.makeText(TripPageActivity.this, "��λ�У����Ժ�",
				...
				if (Const.WEATHER_DATA_REQUEST_SUCCESSED == intent.getIntExtra(
					...
					try {
						...
						try {
							...
							// Toast.makeText(HomePageActivity.this, "����������Ϣʧ��",
							// Toast.LENGTH_SHORT);
						}
					} catch (JSONException e) {
						// Toast.makeText(HomePageActivity.this, "��������ʧ��",
						// Toast.LENGTH_LONG).show();
						e.printStackTrace();
					}
					// Toast.makeText(HomePageActivity.this, "�������ݳɹ�",
					// Toast.LENGTH_LONG).show();
					// ������ʾ������
					...
					// "���ӷ�����ʧ��: "+throwable, Toast.LENGTH_LONG).show();
				}
			}
		}
