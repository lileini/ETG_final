...
public class WifiAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.address.setText("位置:" + entity.getAddress());
		holder.distance.setText("距我:" + entity.getDistance() + "m");
		holder.intro.setText("描述:" + entity.getIntro());
		holder.name.setText("名称:" + entity.getName());
